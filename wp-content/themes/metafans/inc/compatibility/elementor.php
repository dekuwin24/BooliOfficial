<?php
function tophive_is_e_theme_location( $location ) {
...
if ( defined( 'ELEMENTOR_VERSION' ) ) {
	add_action( 'elementor/theme/register_locations', 'tophive_elementor_register_locations' );
	/**
	 ...
	 */
	function tophive_elementor_register_locations( $elementor_locations_manager ) {
