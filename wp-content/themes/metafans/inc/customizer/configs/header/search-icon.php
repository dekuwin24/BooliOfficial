...
class Tophive_Builder_Item_Search_Icon {
	...
	function __construct() {
		$this->label = esc_html__( 'Search Icon', 'metafans' );
	}
	...
	function customize() {
		...
		$config   = array(
			...
			array(
				...
				'label'           => esc_html__( 'Icon Padding', 'metafans' ),
			),
			...
			array(
				...
				'description' => esc_html__( 'Search icon styling', 'metafans' ),
				'selector'    => array(
			...
			array(
				...
				'type'    => 'heading',
				'section' => $this->section,
				'label'   => esc_html__( 'Modal Settings', 'metafans' ),
			),
			...
			array(
				...
				'section'     => $this->section,
				'css_format'  => 'styling',
				'title'       => esc_html__( 'Form Styling', 'metafans' ),
				'description' => esc_html__( 'Form modal styling', 'metafans' ),
				'selector'    => array(
			...
			array(
				...
				'label'           => esc_html__( 'Search Modal Width', 'metafans' ),
			),
		...
		<div class="header-search-modal-wrapper">
			<form role="search" class="header-search-modal header-search-form" action="<?php echo esc_url( home_url( '/' ) ); ?>">
				<label>
					...
					<input type="search" class="search-field" placeholder="<?php echo esc_attr( $placeholder ); ?>" value="<?php echo get_search_query(); ?>" name="s" title="<?php echo esc_attr_x( 'Search for:', 'label', 'metafans' ); ?>" />
				</label>
...
Tophive_Customize_Layout_Builder()->register_item( 'header', new Tophive_Builder_Item_Search_Icon() );
