...
class Tophive_Builder_Item_Search_Box {
	...
	function __construct() {
		$this->label = esc_html__( 'Search Box', 'metafans' );
	}
...
Tophive_Customize_Layout_Builder()->register_item( 'header', new Tophive_Builder_Item_Search_Box() );
