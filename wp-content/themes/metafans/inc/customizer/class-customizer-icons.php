...
class Tophive_Font_Icons {
	...
	function get_icons() {
		if ( is_null( self::$_icons ) ) {
			$icons        = array(
				'font-awesome' => array(
					'name'         => esc_html__( 'FontAwesome', 'metafans' ),
			...
			self::$_icons = apply_filters( 'tophive/customizer/font_icons', $icons );
		}
	...
	function is_used() {
		...
		$check = apply_filters( 'tophive/load-icons', true );
		if ( is_null( $check ) ) {
			$builders = array( 'header_builder_panel', 'footer_builder_panel' );
			$list     = apply_filters( 'tophive/icon_used', array() );

			foreach ( $builders as $setting_key ) {
				$data = tophive_metafans()->get_setting( $setting_key );
				if ( is_array( $data ) ) {
	...
	function get_font_awesome_icons() {
		...
		return apply_filters( 'tophive/customizer/font_icons/font_awesome_icons', $icons );
	}
