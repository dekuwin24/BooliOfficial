<?php
class Tophive_Customizer_Control_Radio extends Tophive_Customizer_Control_Base {
	public $disabled_msg;
	...
	static function field_template() {
		echo '<script type="text/html" id="tmpl-field-tophive-radio">';
		self::before_field();
		?>
		<#
