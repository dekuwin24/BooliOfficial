    ...
    <div class="ld-table-list-header ld-primary-background">
        ...
        <div class="ld-table-list-title">
            ...
            <span class="ld-text">
    			...
    			echo sprintf( esc_html_x( '%s Content', 'Lesson Content Label', 'metafans' ), esc_attr(LearnDash_Custom_Label::get_label('lesson')) ); ?>
            </span>
        ...
        <div class="ld-table-list-lesson-details">
            ...
            <?php if($lesson_progress): ?>
                <span class="ld-lesson-list-progress"><?php echo sprintf( esc_html_x( '%s%% Complete', 'Lesson Complete Percentage', 'metafans' ), $lesson_progress['percentage'] ); ?></span>
                <span class="ld-lesson-list-steps"><?php echo sprintf( esc_html_x( '%1$d/%2$d Steps', 'Lesson Steps Complete', 'metafans' ), $lesson_progress['completed'], $lesson_progress['total'] ); ?></span>
            <?php endif; ?>
            ...
            <?php if( 'sfwd-lesson' === get_post_type() ): ?>
                <span class="ld-expand-button" data-ld-expands="<?php echo esc_attr( 'ld-topic-list-' . $lesson['post']->ID ); ?>">
                    ...
                    <span class="ld-text"><?php esc_html_e( 'Expand', 'metafans' ); ?></span>
