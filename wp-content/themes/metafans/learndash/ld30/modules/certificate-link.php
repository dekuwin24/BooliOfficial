...
<div class="ld-course-certificate">
    ...
    <a href="<?php echo esc_attr($course_certficate_link); ?>" class="ld-button"><span class="ld-icon ld-icon-certificate"></span> <?php esc_html_e( 'Download Certificate', 'metafans' ); ?></a>
    <?php
