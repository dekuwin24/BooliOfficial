...
$has_lesson_quizzes = learndash_30_has_lesson_quizzes( $course_id, $lessons ); ?>
 ...
 <div class="<?php echo esc_attr( learndash_the_wrapper_class() ); ?>">
    ...
    <div class="mf-ld-course-grid">

		<div class="mf-learndash-content-wrap">
            ...
            if( isset( $course_certficate_link ) && $course_certficate_link && !empty($course_certficate_link) ):
                ...
                learndash_get_template_part( 'modules/alert.php', array(
                    ...
                    'icon'      =>  'certificate',
                    'message'   =>  __( 'You\'ve earned a certificate!', 'metafans' ),
                    'button'    =>  array(
                        'url'   =>  $course_certficate_link,
                        'icon'  =>  'download',
                        'label' =>  __( 'Download Certificate', 'metafans' )
                    )
                ), true );
            ...
            if( $has_course_content && $show_course_content ): ?>
                ...
                <div class="ld-item-list ld-lesson-list">
                    <div class="ld-section-heading">
                        ...
                        <h2><?php printf( esc_html_x( '%s Content', 'Course Content Label', 'metafans' ), esc_attr( LearnDash_Custom_Label::get_label( 'course' ) ) ); ?></h2>
                        ...
                        <div class="ld-item-list-actions" data-ld-expand-list="true">
                            ...
                            if( $has_topics || $has_lesson_quizzes ): ?>
                                <div class="ld-expand-button ld-primary-background" id="<?php echo esc_attr( 'ld-expand-button-' . $course_id ); ?>" data-ld-expands="<?php echo esc_attr( 'ld-item-list-' . $course_id ); ?>" data-ld-expand-text="<?php echo esc_attr_e( 'Expand All', 'metafans' ); ?>" data-ld-collapse-text="<?php echo esc_attr_e( 'Collapse All', 'metafans' ); ?>">
