    ...
    <div class="ld-item-list-item-preview">
        ...
        <div class="ld-item-details">
            ...
            if ( !empty( $certificateLink ) ): ?>
                <a class="ld-certificate-link" target="_blank" href="<?php echo esc_attr($certificateLink); ?>" aria-label="<?php esc_attr_e( 'Certificate', 'metafans' ); ?>"><span class="ld-icon ld-icon-certificate"></span></span></a>
            <?php endif; ?>
