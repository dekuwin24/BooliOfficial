    ...
    <div id="ld-profile" data-shortcode_instance="<?php echo $shortcode_data_json; ?>">
            ...
            <div class="ld-profile-summary">
                <div class="ld-profile-card">
                    ...
                    if( current_user_can('read') && isset($shortcode_atts['profile_link']) && true === $shortcode_atts['profile_link'] && apply_filters( 'learndash_show_profile_link', $shortcode_atts['profile_link'] ) ): ?>
        				<a class="ld-profile-edit-link" href='<?php echo get_edit_user_link(); ?>'><?php esc_html_e( 'Edit profile', 'metafans' ); ?></a>
                    <?php endif; ?>
                </div> <!--/.ld-profile-card-->
                <div class="ld-profile-stats">
                    ...
                    $ld_profile_stats = array(
                        ...
                        array(
                            'title' =>  __( 'Completed', 'metafans' ),
                            'value' =>  $user_stats['completed'],
                        ),

                        array(
                            'title' => __( 'Certificates', 'metafans' ),
					...
					if( isset($shortcode_atts['course_points_user']) && $shortcode_atts['course_points_user'] == 'yes' ) {
						$ld_profile_stats[] = array(
		                            'title' => esc_html__( 'Points', 'metafans' ),
        ...
        <div class="ld-item-list ld-course-list">
            ...
            <div class="ld-section-heading">
                <h3><?php printf( esc_html_x( 'Your %s', 'Profile Course Content Label', 'metafans' ), esc_attr( LearnDash_Custom_Label::get_label( 'courses' ) ) ); ?></h3>
                <div class="ld-item-list-actions">
                    <div class="ld-search-prompt" data-ld-expands="ld-course-search">
                        <?php echo esc_html__( 'Search', 'metafans' ); ?> <span class="ld-icon-search ld-icon"></span>
                    </div> <!--/.ld-search-prompt-->
                    <div class="ld-expand-button" data-ld-expands="ld-main-course-list" data-ld-expand-text="<?php echo esc_attr_e( 'Expand All', 'metafans' ); ?>" data-ld-collapse-text="<?php echo esc_attr_e( 'Collapse All', 'metafans' ); ?>">
                        <span class="ld-icon-arrow-down ld-icon"></span>
                        <span class="ld-text"><?php echo esc_html_e( 'Expand All', 'metafans' ); ?></span>
            ...
            <div class="ld-item-list-items" id="ld-main-course-list" data-ld-expand-list="true">
                ...
                if( !empty($user_courses) ):
					...
					$alert = array(
				        ...
				        'message' => sprintf( esc_html_x( 'No %s found', 'placeholder: Courses', 'metafans' ), esc_html( LearnDash_Custom_Label::get_label('courses') ) ),
				        'type'    => 'warning',
				    );
