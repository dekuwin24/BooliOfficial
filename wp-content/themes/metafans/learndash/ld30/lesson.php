...
if ( empty( $course_id ) ) {
	...
	if ( empty( $course_id ) ) {
		$course_id = (int) apply_filters( 'tophive/learndash/single-course/course-id', $lesson_data->ID );
    }
}
...
$content_urls            = apply_filters( 'tophive/learndash/single-course/custom-pagination', $course_id, $lession_list );
                    ...
                    <div id="learndash-course-header" class="bb-lms-header">
                        ...
                        <div class="ec-d-flex mf-ld-position">
                            <div class="sfwd-course-position">
                                <span class="bb-pages"><?php echo LearnDash_Custom_Label::get_label( 'lesson' ); ?> <?php echo $lesson_no; ?> <span class="bb-total"><?php _e( 'of', 'metafans' ); ?> <?php echo sizeof( $lession_list ); ?></span></span>
                            </div>
                    ...
                    <?php
                        ...
                        if ( $show_content ) :
                        	...
                        	if( !empty($topics) || !empty($quizzes) ):
                                ...
                                echo '<div class="ld-lesson-topic-list">';
