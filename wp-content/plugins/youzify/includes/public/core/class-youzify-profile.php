...
class Youzify_Profile {
	...
	function profile_scripts() {
        ...
        // Load Profile Courses Tab Style
        // wp_enqueue_style( 'youzify-courses', YOUZIFY_ASSETS . 'css/youzify-courses.min.css', array(), YOUZIFY_VERSION );
        
        // wp_enqueue_style( 'youzify-certificates', YOUZIFY_ASSETS . 'css/youzify-certificates.min.css', array(), YOUZIFY_VERSION );

		// wp_enqueue_script( 'youzify-courses-js', YOUZIFY_ASSETS . 'js/youzify-courses-switch.min.js', array( 'jquery' ), YOUZIFY_VERSION, true  );
